...
//                {"!@#$%^&*()_+@mail.xx"}
    ...
    @Test(priority = 1,
            description = "Ввод некорректной почты при регистрации", dataProvider = "randomEmail")
...
//                .inputMail(EMAIL);
    ...
    @Test(priority = 1,
            description = "получить письмо для восстановления доступа", dataProvider = "randomEmail")
