...
//
//        @Step("Клик на элементе, очистка поля и ввод текста")
//        public static void clickClearEnterValue(WebElement webElement, String value) {
//            WaitT.elementToBeClickable(webElement);
//            webElement.click();
////            webElement.click();
////            webElement.clear();
...
//        public  ActionT.OneClick enterTextFromTextValue(WebElement webElement, String value) {
...
////
////    /** Одиночный клик на элемент и ввод текста */
////    @Step("Клик на элементе, очистка поля и ввод value")
////    public static void clearClickEnterValue(WebElement webElement, String value) {
////        WaitT.elementToBeClickable(webElement);
////        webElement.click();
////        webElement.clear();
////        webElement.sendKeys(value);
////    }
////
////    @Step("Клик на элементе, очистка поля и ввод текста по символам")
////    public static void clickClearEnterValue(WebElement webElement, String value) {
////        WaitT.elementToBeClickable(webElement);
////        webElement.click();
////        webElement.sendKeys(CONTROL + "a");
...
////            WaitT.littleWait(150);
////        }
////    }
////
////    @Step("Клик на элементе, очистка поля и ввод текста по символам")
////    public static void clickClearEnterValue2(WebElement webElement, String value) {
////        WaitT.elementToBeClickable(webElement);
////        webElement.click();
////        webElement.sendKeys(BACK_SPACE);
////        webElement.sendKeys(BACK_SPACE);
////        webElement.sendKeys(BACK_SPACE);
////
////        char[] chars = value.toCharArray();
...
////    /** Одиночный клик на элемент и ввод текста */
////    @Step("Кликнуть на поле очистить и ввести текст: '{text}'")
////    public static void clickClearAndEnterText(WebElement webElement, String text) {
////        log.info("Нажать на поле и ввести текст " + text);
////        webElement.click();
////        webElement.sendKeys(CONTROL + "a");
////        webElement.sendKeys(DELETE);
...
////    /** Одиночный клик на элемент и ввод текста */
////    @Step("Кликнуть на поле и ввести текст: '{text}'")
////    public static void clickAndEnterValue(WebElement webElement, String value) {
////        log.info("Нажать на поле и ввести текст " + value);
////        webElement.click();
////        SendAction.selectText(webElement);
////        WaitT.littleWait(500);
...
////        log.info("Текст в последнем элементе списка --> " + lastListText);
////        WaitT.littleWait(300);
////        actions.moveToElement(list.get(list.size() - 1));//div[contains(@class, 'drop-down')]//li.click().build().perform();
////        WaitT.littleWait(300);
////        return lastListText;
////    }
////
...
////        for (WebElement option : options) {
////            Move.moveToElement(option);
////            if (option.getText().contains(elementName)) {
...
////
////    @Step("Выбрать элемент из списка по его имени: {elementName}")
////    public static void selectElementFromListByNameSelectFromDataTitle3(String elementName, String locator) {
////        //List<WebElement> options = getDriverInstance().findElements(By.xpath("//div[contains(@class, 'drop-down')]//ul//li"));
////        List<WebElement> options = getDriverInstance().findElements(By.xpath(locator));
////
////        WaitT.littleWait(1000);
////        for (WebElement option : options) {
////            Move.moveToElement(option);
